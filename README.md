...
-- Thêm ngay sau khi tạo Tabs
-- Tạo nút thu nhỏ UI
local MinimizeButton = Window:AddButton({
    Title = "Minimize UI",
    Callback = function()
        Window.Window.Frame.Visible = false -- Ẩn UI chính
        LogoButton.Visible = true -- Hiện logo nhỏ
    end
})
-- Tạo logo nhỏ
local LogoButton = Instance.new("ImageButton")
LogoButton.Size = UDim2.new(0, 50, 0, 50) -- Kích thước logo nhỏ
LogoButton.Position = UDim2.new(0, 20, 0, 100) -- Vị trí trên màn hình
LogoButton.Image = "rbxassetid://123456789" -- Thay bằng ID hình ảnh logo của bạn
LogoButton.BackgroundTransparency = 1 -- Ẩn nền
LogoButton.Visible = false -- Ẩn logo lúc đầu
LogoButton.Parent = game.CoreGui
-- Khi bấm vào logo, mở lại UI
LogoButton.MouseButton1Click:Connect(function()
    Window.Window.Frame.Visible = true -- Hiện lại UI
    LogoButton.Visible = false -- Ẩn logo
end)
